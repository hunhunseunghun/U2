				...
				<section className="challenge_wrap">
					<section className="challenge_tab">
						<div
							className={
								tabActive === 0
									? 'tab_entire tab_active challenge_ele_tab'
									: 'tab_entire challenge_ele_tab'
							}
							onClick={() => {
								handleTabChange(0);
							}}
						...
						<div
							className={
								tabActive === 1
									? 'tab_compte tab_active challenge_ele_tab'
									: 'tab_compte challenge_ele_tab'
							}
							onClick={() => {
								handleTabChange(1);
							}}
						...
						<div
							className={
								tabActive === 3
									? 'tab_cv tab_active challenge_ele_tab'
									: 'tab_cv challenge_ele_tab'
							}
							onClick={() => {
								handleTabChange(3);
							}}
						...
						<div
							className={
								tabActive === 2
									? 'tab_ve tab_active challenge_ele_tab'
									: 'tab_ve challenge_ele_tab'
							}
							onClick={() => {
								handleTabChange(2);
							}}
						...
						<div
							className={
								tabActive === 4
									? 'tab_ir tab_active challenge_ele_tab'
									: 'tab_ir challenge_ele_tab'
							}
							onClick={() => {
								handleTabChange(4);
							}}
