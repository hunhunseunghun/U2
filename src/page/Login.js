...
function Login(props){
    ...
    useEffect(()=>{
        ...
        if(location.hash) googleToken=location.hash.match(/\#(?:access_token)\=([\S\s]*?)\&/)[1]; //구글로그인 토큰

      if(googleToken){ //구글로그인되었을 때
          axios({
              method: 'get',
        ...
        <div className={'contents_wrap'}>
          <div className={'login_section'}>
             <div className={'login_container'}>
                 <div className={'logo_section'}><Link to={'/'}><img src={'/img/logo_g.svg'}/></Link></div>
