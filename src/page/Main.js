...
function Main(props){
    ...
    useEffect(()=>{
        if(window.innerWidth<900){
            setMobileYn(true);
            document.querySelector('.intro1').style.height=window.innerHeight+'px';
        }
    ...
    useEffect(()=>{
        function tick(){
            return setTimeout(()=>{
                gsap.fromTo('.co_'+(quoteCount%3),1,{left:'50%'},{left:'-200%'});
                gsap.fromTo('.co_'+((quoteCount+1)%3),1,{left:'200%'},{left:'50%'});
    ...
    return(
        <div className={'contents_wrap'}>
            ...
            <div className={'intro intro1'} style={{backgroundImage:'url(/img/main12'+(mobileYn?'_m':'')+'.jpg)'}}>
            ...
            <div className={'intro intro2'}>
                ...
                <div className={'main_copy'}>
                    U2 서비스는, 여러분이 영상 편집 장비 구비와 기술을 공부하는데 많은 시간과 돈을 허비하는 대신,<br/>
                    자산의 영상을 기획하고 동료와 함께 협력하는 본연의 작업에 더욱 집중할 수 있도록 해줍니다.<br/>
                    <br/>
                    초보 영상 편집자라도 U2에서 필요한 영상 편집 법만 골라 찾고 그에 맞는 영상 편집 SW를 골라  따라하면 어려운 특수효과도 순식간에 전문가처럼 표현할 수 있어요.<br/>
                    영상편집 강사분들이 U2 앱만 설치하면, 한시간 넘게 걸리던 학생 노트북PC에 각종 영상편집 SW 설치와 파일 공유하는 강의 준비 과정 없이 즉시 강의 시작 가능합니다.
                  </div>
            </div>
            <div className={'intro intro3'}>
                <div className={'main_copy'}>최신 클라우드 기술을 통해<br/>
                    최고사양 컴퓨터에서 여러분의 영상을<br/>
                    편집하고 제작하세요!
                </div>
                <div className={'deco_img'}><img src={'/img/main02.png'}/></div>
                <div className={'strength_items'}>
                    <div className={'st_item'}>
                        <div className={'st_title'}>찾기 쉬운 영상제작 정보</div>
                        <div className={'st_contents'}>검색할 필요없이, 쉽고 빠르게 영상제작 정보를 얻을 수 있어요.
                            TV, 유명 유튜버처럼 영상편집효과를 직접 배워서 만들 수 있어요.
                            영상제작 어디서부터 시작해야할지 모를 때 참고해보세요.
                        </div>
                    </div>
                    <div className={'st_item'}>
                        <div className={'st_title'}>즉시 시작 가능한 영상제작</div>
                        <div className={'st_contents'}>설치없이 로그인만으로 영상제작이 가능해요.
                            카페에서 저사양 노트북으로도 4K 영상제작이 가능해요.
                            이동하면서 영상을 빠르게 업로드/다운로드 할 수 있어요.
                        </div>
                    </div>
                    <div className={'st_item'}>
                        <div className={'st_title'}>돈이 되는 부가기능</div>
                        <div className={'st_contents'}>영상제작을 통해 새로운 수입을 만들어보세요.
                            내가 만든 영상으로 나를 표현해보세요.
                            정보/프로그램소/부가기능이 한 눈에 쉽고 빠르게 정돈해보세요.
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className={'price_items'}>
                    <div className={'pr_item'}>
                        ...
                        <div className={'pr_contents'}>
                            <div className={'pr_main_copy'}>영상편집을 시작하는 분께 적합한 요금제 입니다.</div>
                            <div className={'pr_desc'}>영상공유/리뷰 기능을 사용할 수 있습니다.<br/>
                                U2만의 전용 영상 제작 팁과 영상 트렌드를 쉽게 확인할 수 있습니다.<br/>
                                인터넷만 제공되면 언제 어디서나 영상편집을 하실 수 있습니다.
                            </div>
                        </div>
                        <div className={'pr_bt_section'}>
                            <div className={'default_bt go_to_price_bt'}>요금제 자세히보기</div>
                        </div>
                    </div>
                    <div className={'pr_item'}>
                        <div className={'pr_title'}>5G 프리미어 플러스</div>
            ...
            <div className={'intro intro6'} style={{backgroundImage:'url(/img/main6.jpg)'}}>
                ...
                <div className={'copy_items'}>
                    <div className={'copy_item co_0'}>
                        <div className={'main_copy'}>
                            ...
                            U2 서비스는 영상편집 초심자는 물론 전문가까지 모두를 위한 플랫폼이에요.
                            초심자분들은 큐레이션을 통해 원하는 정볼르 쉽고 빠르게 찾아 영상편집을 할 수 있고,
                            전문가들은 고사양이 요구되는 전문영상 편집을 이동 중에도 할 수 있는 장점이 있어요.
                ...
                <div className={'faq_items'}>
                    <div className={'faq_item active'}>
                        <div className={'faq_header'}>
                            ...
                            <div className={'faq_title'}>진짜 프로그램 설치없이 영상제작을 할 수 있나요?</div>
                            <div className={'faq_cate'}>영상제작 정보</div>
                            <div className={'faq_deco'}><img src={'/img/ic_arrow_up_w.svg'}/></div>
                        </div>
                        <div className={'faq_contents'}>
                            <div className={'faq_num'}>A.1</div>
                            네. U2는 인터넷 연결만 되어 있으면 사용할 수 있는 서비스에요. 원격지의 고성능 서버에서 영상제작 프로그램이 동작하고 있고, 인터넷을 통해 넷플릭스처럼 화면만 스트리밍 해와요그래서 노트북으로도 4K편집 같은 높은 사양을 요구하는 영상제작 작업을 할 수 있어요.
                        </div>
                    </div>
                    <div className={'faq_item'}>
                        <div className={'faq_header'}>
                            ...
                            <div className={'faq_title'}>진짜 프로그램 설치없이 영상제작을 할 수 있나요?</div>
                            <div className={'faq_cate'}>영상제작 정보</div>
                            <div className={'faq_deco'}><img src={'/img/ic_arrow_down.svg'}/></div>
                        </div>
                        <div className={'faq_contents'}>
                            <div className={'faq_num'}>A.1</div>
                            네. U2는 인터넷 연결만 되어 있으면 사용할 수 있는 서비스에요. 원격지의 고성능 서버에서 영상제작 프로그램이 동작하고 있고, 인터넷을 통해 넷플릭스처럼 화면만 스트리밍 해와요그래서 노트북으로도 4K편집 같은 높은 사양을 요구하는 영상제작 작업을 할 수 있어요.
