...
const CompetitionRegi = () => {
	...
	const handleSubmit = () => {
		...
		camp && rewards.push({ cat: 3, rewarddesc: '국내캠프' });
		scatterPoint && rewards.push({ cat: 4, rewarddesc: '입사시 가산점' });
		intern && rewards.push({ cat: 5, rewarddesc: '인턴채용' });
		full_time && rewards.push({ cat: 6, rewarddesc: '정직원채용' });
		prize && rewards.push({ cat: 7, rewarddesc: '경품' });
		...
		<RegiContainer className="competitionregi_contents_wrap">
			<div className="competitionregi_section">
				...
				<section className="competitionregi_items">
						...
						<div className="inputInfo">
							<div className="competition_name">
								<input
									...
									maxLength={20}
								/>
								<div> 공모전 명은 20자 이내로 작성해 주십시오.</div>
							</div>
						</div>
					</section>
					<section className="ele">
						...
						<div className="inputInfo">
							<div className="competition_organizer">
								<input
									...
									maxLength={20}
								/>
								<div>주관사 명은 20자 이내로 작성해 주십시오</div>
							</div>
						</div>
					</section>
					<section className="ele">
						...
						<div className="inputInfo">
							<div className="competition_sponsor">
								<input
									...
									maxLength={20}
								/>
								<div>후원사 명은 20자 이내로 작성해 주십시오</div>
							</div>
						</div>
					</section>
					<section className="ele">
						...
						<div className="inputInfo">
							<div className="competition_webpageURL">
								...
								/>
								<div>홈페이지 주소가 정확하게 입력되었는지 확인해 주세요</div>
							</div>
						</div>
					</section>
					<section className="ele">
					...
					<section className="ele">
						<div className="menu">* 제출자{<br />}개인정보 수집</div>
						<div className="inputInfo reception_info">
							<div className="reception_form">
								<table className="reception_table">
									<tbody>
