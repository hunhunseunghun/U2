...
import { Container } from './PosterUploaderStyled.jsx';

const PosterUploader = ({ file, setFile, filePath, setFilePath }) => {
  ...
  const fileChangeFunc = e => {
    ...
    if (document.getElementById('posterUploader').value) {
      setFilePath(document.getElementById('posterUploader').value);
    } else {
